...
class Device(Base):
    ...
    serial_number: Mapped[str] = mapped_column(String(120), default="unknown")
    installed_software_json: Mapped[list] = mapped_column(JSON, default=list)
    software_usage_json: Mapped[dict] = mapped_column(JSON, default=dict)
    prohibited_software_alerts: Mapped[list] = mapped_column(JSON, default=list)
    ...
    bitlocker_status: Mapped[str] = mapped_column(String(30), default="unknown")
    usb_control_status: Mapped[str] = mapped_column(String(30), default="not_enforced")
    browser_control_status: Mapped[str] = mapped_column(String(30), default="not_enforced")
...
class MobileDevice(Base):
    ...
    app_control_status: Mapped[str] = mapped_column(String(30), default="managed")
    last_seen: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class Patch(Base):
    ...
    target_group: Mapped[str] = mapped_column(String(120), default="all-devices")
